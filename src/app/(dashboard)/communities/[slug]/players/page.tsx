          ...
          {inviteUrl ? (
            <div className="space-y-3">
              ...
              <div className="flex gap-3">
                <a href={`https://wa.me/?text=${encodeURIComponent(`Join our padel community on PadelTribe! ${inviteUrl}`)}`} target="_blank" rel="noopener noreferrer"
                ...
                <a href={`https://t.me/share/url?url=${encodeURIComponent(inviteUrl)}&text=${encodeURIComponent('Join our padel community on PadelTribe!')}`} target="_blank" rel="noopener noreferrer"
